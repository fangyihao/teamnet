...
File format expected:
  * h5 file
  * h5 datasets should include {train, valid, mnist}_{in, na, out}, which will
    map to inputs, targets mask, and targets for the train, dev, and mnist
    datasets.
  ...
  def generate_data(self, data_dir, tmp_dir, task_id=-1):
    ...
    datasets = [(self.training_filepaths, self.num_shards, "train",
                 num_train_examples), (self.dev_filepaths, 10, "valid",
                                       num_dev_examples),
                (self.test_filepaths, 10, "mnist", num_test_examples)]
    ...
    # 1 per training shard + 10 for dev + 10 for mnist
