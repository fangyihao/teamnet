...
def cifar_generator(cifar_version, tmp_dir, training, how_many, start_from=0):
  ...
  Args:
    cifar_version: string; one of "cifar10_e2" or "cifar100"
    tmp_dir: path to temporary storage directory.
    training: a Boolean; if true, we use the train set, otherwise the mnist set.
...
class ImageCifar10Tune(mnist.ImageMnistTune):
  ...
  def generator(self, data_dir, tmp_dir, is_training):
    if is_training:
      return cifar_generator("cifar10_e2", tmp_dir, True, 48000)
    else:
      return cifar_generator("cifar10_e2", tmp_dir, True, 2000, 48000)
...
class ImageCifar10(ImageCifar10Tune):
  ...
  def generator(self, data_dir, tmp_dir, is_training):
    if is_training:
      return cifar_generator("cifar10_e2", tmp_dir, True, 50000)
    else:
      return cifar_generator("cifar10_e2", tmp_dir, False, 10000)
