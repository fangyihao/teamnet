...
def create_parser():
    ...
    parser.add_argument(
        '--model_dir', default = "cifar10_e2/ckpt", 
        help="train directory")
     
    parser.add_argument(
        '--data_dir', default = "cifar10_e2/data", 
        help="data directory")
    
    parser.add_argument(
        '--tmp_dir', default = "cifar10_e2/tmp", 
        help="temporary directory")
    
    parser.add_argument(
        '--log_dir', default = "cifar10_e2/log", 
        help="train directory")
...
#model_dir_col = ["cifar10_e2/ckpt_ssbig_l8_e4", "cifar10_e2/ckpt_ssbig_l14_e2", "cifar10_e2/ckpt_ssbig_l26_e1"]
hparams_col = ["shakeshake_big_l8", "shakeshake_big_l14", "shakeshake_big_l26"]
batch_size_col = [512,256,128]
num_experts_col = [4,2,1]
for i, num_experts in enumerate(num_experts_col):
    params.device= [3]
    #params.gate_device= [0,1,2]
    #params.num_gates = 4
    if num_experts == 1:
        for j in range(60):
            ...
            params.model_dir = "cifar10_e2/ckpt_%s_%s_e%d"%(hparams_col[i],'rs' if params.reshuffle_each_epoch else 'nrs',num_experts)
